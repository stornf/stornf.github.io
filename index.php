                    ...
                    <div class="form-horizontal col-xs-12 col-sm-12 col-md-12">
                        <form  role="form" method="POST" action="">
                            <fieldset>
                              ...
                              <button class='form-control btn btn-primary submit-button' type='submit' value="Submit" name="submit" style="margin-bottom: 10px;">توقيع التطبيق → </button>
                            ...
                            <div class="row">
                                <div class="col-md-12 cta-contents text-right">
                                    <div class="cta-desc">
                                        ...
                                        <a href="##" class="btn btn-block btn-default">شرح التثبيت <i class="glyphicon glyphicon-hand-left"></i></a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <p> يجب ان يكون الرابط مباشر بهذه الطريقة 1</p>
                <p>http://s-7at.co.nf/snapchat.ipa</p>
